...
int main(void) {
    const size_t num_of_kernels = 2; // number of kernels
    ...
    if (topological_sort(dependencies, num_of_kernels, resolved)) {
        ...
        size_t index_i;
        size_t index_j;
//        for (auto pair1 : dependencies) {
//            for (auto pair2 : dependencies) {
...
//                else
        ...
        std::cout<< dependencies[index_i].first << " <---> "  <<dependencies[index_j].first<< std::endl;
   // }
